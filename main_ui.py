...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # TAB INDEX ORDER
        MainWindow.setTabOrder(self.pushButton_minimize, self.pushButton_max_rest)
        MainWindow.setTabOrder(self.pushButton_max_rest, self.pushButton_close)
        MainWindow.setTabOrder(self.pushButton_close, self.lineEdit_values)
        MainWindow.setTabOrder(self.bt_0, self.bt_1)
        ...
        MainWindow.setTabOrder(self.bt_9, self.bt_dot)
        MainWindow.setTabOrder(self.bt_clear, self.bt_backspace)
        MainWindow.setTabOrder(self.bt_backspace, self.bt_div)
        MainWindow.setTabOrder(self.bt_div, self.bt_multiply)
        MainWindow.setTabOrder(self.bt_multiply, self.bt_minus)
        MainWindow.setTabOrder(self.bt_minus, self.bt_plus)
        MainWindow.setTabOrder(self.bt_plus, self.bt_equal)
        MainWindow.setTabOrder(self.bt_equal, self.bt_copy)
